...
namespace FarAndWide
{
	public class FWGrid : GLMonoBehaviour
	{
		...
		private void BuildGrid()
		{
			...
			grid = RectGrid<SpriteCell>.Rectangle(6, 6);
        ...
        public SpriteCell[] getCorners() {
            SpriteCell[] cells = new SpriteCell[4];
